...
const images = [
  ...
  'https://images.unsplash.com/photo-1594938298603-c8148c4b4f8f?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1541101767792-f9b2b1c4f127?w=300&h=300&fit=crop',
];
      ...
      <div className="w-full">
        ...
        <div className="flex overflow-x-auto scrollbar-hide">
          {images.map((image, index) => (
            <div key={index} className="flex-shrink-0 w-48 h-48 sm:w-64 sm:h-64 relative group">
              <img
                src={image}
