...
export default function StatsCard({ label, value, icon, trend, className = '' }: StatsCardProps) {
  ...
  return (
    <div
      className={`bg-white border border-neutral-200 shadow-sm p-5 flex flex-col gap-4 ${className}`}
    >
      <div className="flex items-start justify-between">
        ...
        <div className="flex-shrink-0 w-11 h-11 bg-[#1a237e]/10 flex items-center justify-center text-xl">
          {icon}
        </div>
      </div>
