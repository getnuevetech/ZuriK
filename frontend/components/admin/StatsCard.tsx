    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-1">
          <span className="text-[11px] font-semibold text-[#7e8fbc] uppercase tracking-[0.18em]">{label}</span>
          <span className="text-3xl font-semibold text-[#1f2f62] font-heading">{value}</span>
        </div>
        <div className="flex-shrink-0 w-11 h-11 rounded-full bg-[#e4ebfb] text-[#2b3f72] flex items-center justify-center text-xl">
          {icon}
        </div>
      </div>
