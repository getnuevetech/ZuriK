...
const storeLinks = [
  ...
  { name: 'Designers', href: '/designers' },
  { name: 'Custom Design', href: '/orders/custom-design' },
];
...
export default function MuebleFooter() {
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <ul className="space-y-4">
              {featuredProducts.map((product) => (
                <li key={product.name} className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-white/10 flex-shrink-0 flex items-center justify-center text-white/40 text-xs">
                    AF
                  </div>
                  <div>
          ...
          <div>
            ...
            {submitted ? (
              <div className="text-[#00c853] text-sm py-4">
