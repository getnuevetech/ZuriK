  ...
  return (
    <Link href={href} className="group block bg-white rounded-xl overflow-hidden border hover:shadow-lg transition-all duration-300" style={{ borderColor: 'var(--color-border)' }}>
      <div className="aspect-[3/4] overflow-hidden relative rounded-t-xl">
        ...
        {badge && (
          <span className="absolute top-3 left-3 text-white text-xs font-semibold px-2 py-1 rounded-full" style={{ backgroundColor: 'var(--color-primary)' }}>
            {badge}
          </span>
        )}
        {/* Wishlist heart */}
    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-10">
          ...
          <Link href="/designs" className="hidden md:inline text-sm font-semibold uppercase tracking-wider transition-colors hover:opacity-80" style={{ color: 'var(--color-primary)' }}>
            View All →
          </Link>
        </div>
