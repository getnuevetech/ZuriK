...
export function FeaturedFabrics() {
  ...
  return (
    <section className="py-20 px-4" style={{ backgroundColor: '#f8f3ec' }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="mueble-eyebrow mb-2">Premium materials</p>
            <h2 className="font-heading text-3xl font-semibold mueble-section-title">Featured Fabrics</h2>
            <div className="mt-3 h-1 w-14 rounded" style={{ backgroundColor: 'var(--color-secondary)' }} />
          </div>
          <Link href="/fabrics" className="hidden md:inline mueble-link transition-colors">
            View All →
          </Link>
        </div>
